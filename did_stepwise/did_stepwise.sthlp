...
{phang}{cmd: Example}{p_end}
{phang}{cmd: net install did_stepwise, from("https://raw.githubusercontent.com/timbulwidodostp/did_stepwise/main/did_stepwise") replace}{p_end}
{phang}{cmd: import excel "https://raw.githubusercontent.com/timbulwidodostp/did_stepwise/main/did_stepwise/did_stepwise.xlsx", sheet("Sheet1") firstrow clear}{p_end}
{phang}{cmd: *Estimating treatment effects at all horizons*}{p_end}
{phang}{cmd: did_stepwise Dependen Id Year Group}{p_end}
{phang}{cmd: *Also compute an aggregate effect across horizons*}{p_end}
{phang}{cmd: did_stepwise Dependen Id Year Group, agg}{p_end}
{phang}{cmd: *Produce some pretrend estimates*}{p_end}
{phang}{cmd: did_stepwise Dependen Id Year Group, pretrends(4)}{p_end}
{phang}{cmd: *Alternatively add also the pretrend estimate corresponding to the baseline period (mechanically this equals zero)*}{p_end}
{phang}{cmd: did_stepwise Dependen Id Year Group, pretrends(4) includepre1}{p_end}
